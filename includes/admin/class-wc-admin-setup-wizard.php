...
class WC_Admin_Setup_Wizard {
	...
	public function wc_setup_store_setup() {
		...
		<form method="post" class="address-step">
			...
			<label class="location-prompt" for="currency_code">
				<?php esc_html_e( 'Store currency', 'woocommerce' ); ?>
			</label>
			<select
				id="currency_code"
				name="currency_code"
			...
			<p>
				<?php esc_html_e( 'Transforming your site into an online store requires WooCommerce to create a few pages for you. These pages are: shop, cart, my account, and checkout.', 'woocommerce' ); ?>
			</p>
	...
	public function wc_setup_activate() {
		...
		<form method="post" class="activate-jetpack">
			...
			/>
			<p class="wc-setup-actions step">
				<input type="submit" class="button-primary button button-large" value="<?php esc_attr_e( 'Connect to Jetpack through WordPress.com', 'woocommerce' ); ?>" />
			</p>
